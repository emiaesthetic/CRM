...
export const createRow = ({
  ...
  if (!image.includes('notimage.jpg')) {
      ...
      icon: createSVG(20, 20, [
        {
          ...
          2.54767C1.22818 2.75604 1.11111 3.03866 1.11111
          3.33334V16.6667C1.11111 16.9614 1.22818 17.244 1.43655 17.4523C1.64493
          17.6607 1.92754 17.7778 2.22223 17.7778H17.7778C18.0725 17.7778
          18.3551 17.6607 18.5635 17.4523C18.7718 17.244 18.8889 16.9614 18.8889
        ...
        },
        {
          'd': `
            ...
            7.49691C6.15558 7.31377 6.3692 7.05347 6.49535 6.74893C6.62149
            6.44439 6.6545 6.10928 6.59019 5.78598C6.52588 5.46267 6.36715
            5.1657 6.13406 4.93261C5.90097 4.69953 5.604 4.54079 5.2807
            4.47648C4.9574 4.41217 4.62228 4.44518 4.31774 4.57133C4.0132
            4.69747 3.7529 4.91109 3.56976 5.18518C3.38663 5.45926 3.28888
            5.78149 3.28888 6.11113C3.28888 6.55315 3.46447 6.97708 3.77703
            7.28964C4.0896 7.6022 4.51352 7.77779 4.95555 7.77779ZM4.95555
            5.22224C5.13158 5.22114 5.30399 5.27233 5.45089 5.36933C5.5978
            5.46633 5.71259 5.60477 5.78072 5.7671C5.84885
        ...
        },
        {
          'd': `
            ...
            9.31665L3.28888 12.7222V14.2944L7.0611 10.5222L8.88888
            12.3222L6.80555 14.4055H8.33332L13.0278 9.71109L16.6667
            13.3333V11.7666L13.4389 8.53887C13.3348 8.4354 13.194 8.37732
            13.0472 8.37732C12.9004 8.37732 12.7596 8.4354 12.6555 8.53887Z
          `,
          'fill': 'currentColor',
        },
      ]),
    ...
    showBtn = createBtn({
      className: 'table__button button button-reset no-image',
      type: 'button',
      ariaLabel: 'Изображение отсутствует',
      icon: createSVG(20, 20, [
        {
          'd': `M18.75 2.13375L17.8663 1.25L1.25 17.8663L2.13375 18.75L3.38375
        ...
        {
          'd': `M3.75 13.75V11.875L6.875 8.75187L7.73313 9.61062L8.61812
